...
import { communityApi, type WorkKey } from "./api";
...
describe("community app composition", () => {
  it("opens in-place comments from both headers without leaving the album and keeps the standalone community tab", async () => {
    vi.stubGlobal("IS_REACT_ACT_ENVIRONMENT", true);
    const comments = vi.spyOn(communityApi, "work").mockResolvedValue({ items: [], nextCursor: null });
